package com.westongame.smokingiron.blockentity;

import com.westongame.smokingiron.blockentity.inventory.IStorageBlock;
import com.westongame.smokingiron.common.container.WorkbenchContainer;
import com.westongame.smokingiron.init.ModTileEntities;
...
public class WorkbenchBlockEntity extends SyncedBlockEntity implements IStorageBlock
{
    ...
    {
        return Component.translatable("container.smoking_iron.workbench");
    }
