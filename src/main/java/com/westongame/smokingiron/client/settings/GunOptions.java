package com.westongame.smokingiron.client.settings;
...
public class GunOptions
{
    ...
    /*public static final ProgressOption ADS_SENSITIVITY = new GunSliderPercentageOption("smoking_iron.options.adsSensitivity", 0.0, 1.0, 0.01F, gameSettings -> {
        ...
        return Component.translatable("smoking_iron.options.adsSensitivity.format", FORMAT.format(adsSensitivity));
    });

    public static final CycleOption<ResourceLocation> CROSSHAIR = CycleOption.create("smoking_iron.options.crosshair", () -> {
    ...
    /*public static final Option CROSSHAIR = CycleOption.create("smoking_iron.options.crosshair", () -> {
