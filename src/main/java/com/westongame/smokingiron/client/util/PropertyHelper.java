package com.westongame.smokingiron.client.util;
...
import com.westongame.smokingiron.cache.ObjectCache;
import com.westongame.smokingiron.client.MetaLoader;
...
import com.westongame.smokingiron.item.IMeta;
...
public final class PropertyHelper
{
    ...
    public static final String MODEL_KEY = "smoking_iron:model";
    public static final String WEAPON_KEY = "smoking_iron:weapon";
    public static final String SCOPE_KEY = "smoking_iron:scope";
    public static final String BARREL_KEY = "smoking_iron:barrel";
