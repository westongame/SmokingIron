package com.westongame.smokingiron.item.attachment.impl;

import com.westongame.smokingiron.Reference;
import com.westongame.smokingiron.interfaces.IGunModifier;
...
public abstract class Attachment
{
    ...
    public static void addInformationEvent(ItemTooltipEvent event)
    {
        ...
        if(stack.getItem() instanceof IAttachment<?>)
        {
            ...
            {
                event.getToolTip().add(Component.translatable("perk.smoking_iron.title").withStyle(ChatFormatting.GRAY, ChatFormatting.BOLD));
            ...
            {
                addPerk(negativePerks, false, "perk.smoking_iron.fire_volume.negative");
            }
            else if(outputSound < inputSound)
            {
                addPerk(positivePerks, true, "perk.smoking_iron.fire_volume.positive");
            }
            ...
            for(IGunModifier modifier : modifiers)
            {
                ...
                {
                    addPerk(positivePerks, true, "perk.smoking_iron.silenced.positive");
                    break;
                }
            }
            ...
            {
                addPerk(negativePerks, false, "perk.smoking_iron.sound_radius.negative");
            }
            else if(outputRadius < inputRadius)
            {
                addPerk(positivePerks, true, "perk.smoking_iron.sound_radius.positive");
            }
            ...
            {
                addPerk(positivePerks, true, "perk.smoking_iron.additional_damage.positive", ATTRIBUTE_FORMAT.format(additionalDamage / 2.0));
            }
            else if(additionalDamage < 0.0F)
            {
                addPerk(negativePerks, false, "perk.smoking_iron.additional_damage.negative", ATTRIBUTE_FORMAT.format(additionalDamage / 2.0));
            }
            ...
            {
                addPerk(positivePerks, true, "perk.smoking_iron.modified_damage.positive");
            }
            else if(outputDamage < inputDamage)
            {
                addPerk(negativePerks, false, "perk.smoking_iron.modified_damage.negative");
            }
            ...
            {
                addPerk(positivePerks, true, "perk.smoking_iron.projectile_speed.positive");
            }
            else if(outputSpeed < inputSpeed)
            {
                addPerk(negativePerks, false, "perk.smoking_iron.projectile_speed.negative");
            }
            ...
            {
                addPerk(negativePerks, false, "perk.smoking_iron.projectile_spread.negative");
            }
            else if(outputSpread < inputSpread)
            {
                addPerk(positivePerks, true, "perk.smoking_iron.projectile_spread.positive");
            }
            ...
            {
                addPerk(positivePerks, true, "perk.smoking_iron.projectile_life.positive");
            }
            else if(outputLife < inputLife)
            {
                addPerk(negativePerks, false, "perk.smoking_iron.projectile_life.negative");
            }
            ...
            {
                addPerk(negativePerks, false, "perk.smoking_iron.recoil.negative");
            }
            else if(outputRecoil < inputRecoil)
            {
                addPerk(positivePerks, true, "perk.smoking_iron.recoil.positive");
            }
            ...
            {
                addPerk(positivePerks, true, "perk.smoking_iron.ads_speed.positive");
            }
            else if(outputAdsSpeed < inputAdsSpeed)
            {
                addPerk(negativePerks, false, "perk.smoking_iron.ads_speed.negative");
            }
            ...
            {
                addPerk(negativePerks, false, "perk.smoking_iron.rate.negative");
            }
            else if(outputRate < inputRate)
            {
                addPerk(positivePerks, true, "perk.smoking_iron.rate.positive");
            }
    ...
    {
        components.add(Component.translatable(positive ? "perk.smoking_iron.entry.positive" : "perk.smoking_iron.entry.negative", Component.translatable(id, params).withStyle(ChatFormatting.WHITE)).withStyle(positive ? ChatFormatting.DARK_AQUA : ChatFormatting.GOLD));
    }
}
